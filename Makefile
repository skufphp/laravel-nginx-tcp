...
QUEUE_SERVICE=laravel-queue-nginx-tcp
SCHEDULER_SERVICE=laravel-scheduler-nginx-tcp

help: ## Показать справку
	@echo "$(YELLOW)Laravel PHP-FPM and Nginx Docker Boilerplate with TCP$(NC)"
	@echo "======================================"
