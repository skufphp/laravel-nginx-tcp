...
<head>
    ...
    <title>Laravel · PHP-FPM · Nginx · TCP</title>
...
<div class="main-wrapper">
    <div class="main-inner">
        <div class="content-panel">
            <div class="section">
                ...
                <div class="stack-grid">
                    <div class="stack-item">
                        ...
                        <span>Laravel 13</span></div>
                    <div class="stack-item">
                        <div class="stack-icon orange">FPM</div>
                        <span>PHP-FPM pool</span></div>
                    <div class="stack-item">
                        <div class="stack-icon blue">PHP</div>
                        <span>PHP 8.5</span></div>
                    <div class="stack-item">
                        <div class="stack-icon orange">NGX</div>
                        <span>Nginx TCP</span></div>
                    <div class="stack-item">
                        <div class="stack-icon green">PG</div>
                        <span>PostgreSQL 18</span></div>
                    <div class="stack-item">
                        <div class="stack-icon red">R</div>
                        <span>Redis 8.6</span></div>
                </div>
            </div>
            ...
            <div class="section">
                ...
                <div class="services-list">
                    <div class="service-row">
                        ...
                        <span class="service-name">Nginx · PHP-FPM · TCP</span>
                        <span class="service-env">раздельные контейнеры</span>
                    </div>
                    <div class="service-row">
            ...
            <div class="section">
                <div class="section-title">Почему TCP между Nginx и FPM</div>
                <table class="compare-table">
                    <thead>
                    <tr>
                        <th>Плюс</th>
                        <th>Бонус</th>
                        <th class="highlight">Профит</th>
                    </tr>
                    </thead>
                    <tbody>
                    <tr>
                        ...
                        <td class="highlight">кросс-хост</td>
                    </tr>
                    <tr>
                        <td>Раздельно</td>
                        <td>Свой контейнер</td>
                        <td class="highlight">гибкий скейлинг</td>
                    </tr>
                    <tr>
                        <td>PHP-FPM</td>
                        <td>Пулы и лимиты</td>
                        <td class="highlight">ровная нагрузка</td>
                    </tr>
                    <tr>
                        <td>Простота</td>
                        <td>ip:port</td>
                        <td class="highlight">легко дебажить</td>
                    </tr>
                    </tbody>
                </table>
            </div>
        ...
        <div class="hero-panel">
            ...
            <div class="hero-badge">
                <div class="hero-title">PHP-FPM · Nginx · TCP</div>
                <div class="hero-subtitle">Классический Laravel stack</div>
                <div class="version-badges">
                    <span class="badge"><span class="badge-dot orange"></span>PHP 8.5</span>
                    <span class="badge"><span class="badge-dot blue"></span>Nginx</span>
...
<footer class="site-footer">
    Laravel + PHP-FPM + Nginx over TCP · <a href="https://www.php.net/manual/en/install.fpm.php" class="footer-link">php.net/manual/en/install.fpm.php</a>
</footer>
</body>
</html>
